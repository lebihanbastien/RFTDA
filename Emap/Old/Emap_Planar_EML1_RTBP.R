...
ggsave(pE, file=paste0(currentfolder, "R_eOm_", "ofs_" , ofs_order,  "_", Type, "_Energy_EML1_RTBP.pdf"))
ggsave(pE, file=paste0(currentfolder, "R_eOm_", "ofs_" , ofs_order,  "_", Type, "_Energy_EML1_RTBP.eps"))