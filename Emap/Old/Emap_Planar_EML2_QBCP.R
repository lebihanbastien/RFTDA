...
pE = pE+scale_y_continuous(limits=c(-8, 1))+legend_inside_theme
pE
...
ggsave(pE, file=paste0(currentfolder, "R_eOm_", "ofs_" , ofs_order,  "_", Type, "_Energy_EML2_QBCP.pdf"))
ggsave(pE, file=paste0(currentfolder, "R_eOm_", "ofs_" , ofs_order,  "_", Type, "_Energy_EML2_QBCP.eps"))