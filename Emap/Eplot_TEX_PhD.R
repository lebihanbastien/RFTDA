...
#-------------------------------------------------------------------------------
#Plot the precision as a function of the energy gap: initial plot
#-------------------------------------------------------------------------------
xlabel  = "$\\delta H_0$";
...
#-------------------------------------------------------------------------------
#Plot the precision as a function of the energy gap: new plot for manuscript
#-------------------------------------------------------------------------------
xlabel = "$\\delta H_0$";
ylabel = "$E_O(t = 1)$"
llabel = "Order $N$"
pE = plotdf_line(emap, "dHz", "eOm", xlabel, ylabel, "order", llabel, 1)
pE = pE + legend_inside_theme
pE = pE + pE_scale_x + pE_scale_y
pE
...
ggplot2tikz_phd(pE, width = xSize, height = ySize,   file=paste0(currentfolder, "R_eOm_", "ofs_" , ofs_order,  "_", Type, "_Energy.tex"))
