...
# s1-s3 maps
#-------------------------------------------------------------------------------
ppls1s3_eml1 = plotdf_point(imapr_eml1, "s1", "s3", "$s_1$", "$s_3$", pointSize = pS, colorCol = "order", colorLabel = "Order", isColorFac = TRUE)
ppls1s3_eml1

ppls1s3_eml2 = plotdf_point(imapr_eml2, "s1", "s3", "$s_1$", "$s_3$", pointSize = pS, colorCol = "order", colorLabel = "Order", isColorFac = TRUE)
ppls1s3_eml2

#Save in tikz
#-------------------------------------------------------------------------------
#ggplot2tikz(pplc, xSize, ySize, file = paste0(currentfolder, "EIm_", Type, "_ofs_30_order_",toString(i), "_planar_bothpoints.tex"))
ggplot2tikz(pplc, 8.8,  4.6, file = paste0(currentfolder, "EIm_", Type, "_ofs_30_order_",toString(i), "_planar_bothpoints.tex"))
