...
ppt_x0_y0_NCSEM_from_jpl = ppt_x0_y0_NCSEM_from_jpl + annotate("text", x = 0, y = y_annotate.SE,  label = "SEL[2]", size = 5, parse = TRUE)

#Add Earth
ppt_x0_y0_NCSEM_from_jpl = ppt_x0_y0_NCSEM_from_jpl + geom_point(data = dfearth_seml, aes(x= x_NC, y = y_NC), size = 4) 
ppt_x0_y0_NCSEM_from_jpl = ppt_x0_y0_NCSEM_from_jpl + annotate("text", x = -1, y = y_annotate.SE, label = "Earth", size = 5, parse = TRUE)
...
ppt_x0_z0_NCSEM_from_jpl = ppt_x0_z0_NCSEM_from_jpl + annotate("text", x = 0, y = +z_annotate.SE,  label = "SEL[2]", size = 5, parse = TRUE)

#Add Earth
ppt_x0_z0_NCSEM_from_jpl = ppt_x0_z0_NCSEM_from_jpl + geom_point(data = dfearth_seml, aes(x= x_NC, y = z_NC), size = 4) 
ppt_x0_z0_NCSEM_from_jpl = ppt_x0_z0_NCSEM_from_jpl + annotate("text", x = -1, y = +z_annotate.SE, label = "Earth", size = 5, parse = TRUE)
...
ppt_y0_z0_NCSEM_from_jpl = ppt_y0_z0_NCSEM_from_jpl + annotate("text", x = 0, y = -z_annotate.SE,  label = "SEL[2]", size = 5, parse = TRUE)

#Add Earth
#ppt_y0_z0_NCSEM_from_jpl = ppt_y0_z0_NCSEM_from_jpl + geom_point(data = dfearth_seml, aes(x= y_NC, y = z_NC), size = 4) 
#ppt_y0_z0_NCSEM_from_jpl = ppt_y0_z0_NCSEM_from_jpl + annotate("text", x = -1, y = +z_annotate.SE, label = "Earth", size = 5, parse = TRUE)
...
ppt_x0_y0_NCEM_from_jpl = ggplot() + geom_path(data = traj_from_jpl_some_leg1, aes.pk, size = line.size.EM)

# Orbit in black
#ppt_x0_y0_NCEM_from_jpl = ppt_x0_y0_NCEM_from_jpl + geom_path(data = traj_from_jpl_some_emlt, aes.pk, size = line.size.EM, color = "black")
...
ppt_x0_y0_NCEM_from_jpl = ppt_x0_y0_NCEM_from_jpl + scale.color.jpl.local.noguide
ppt_x0_y0_NCEM_from_jpl = ppt_x0_y0_NCEM_from_jpl + scale.line.jpl.local.noguide

# Add EMLi
ppt_x0_y0_NCEM_from_jpl = ppt_x0_y0_NCEM_from_jpl + geom_point(data = dfemli, aes(x= x_NC, y = y_NC), size = 4) 
ppt_x0_y0_NCEM_from_jpl = ppt_x0_y0_NCEM_from_jpl + annotate("text", x = 0, y = -0.7,  label = "EML[2]", size = 5, parse = TRUE)

# Labels
ppt_x0_y0_NCEM_from_jpl = ppt_x0_y0_NCEM_from_jpl + labs(x = x_em, y = y_em)

# Add the Moon
#ppt_x0_y0_NCEM_from_jpl = addMoon(ppt_x0_y0_NCEM_from_jpl, x = dfmoon_eml$x_NC, y = 0, dfmoon_eml$r_NC, surfSize = 0.4, cratSize = 0.2)

# Zoom
ppt_x0_y0_NCEM_from_jpl = ppt_x0_y0_NCEM_from_jpl + scale_x_continuous(limits = lim.x.NEM)
ppt_x0_y0_NCEM_from_jpl = ppt_x0_y0_NCEM_from_jpl + scale_y_continuous(limits = lim.y.NEM)
#ppt_x0_y0_NCEM_from_jpl = ppt_x0_y0_NCEM_from_jpl + ggtitle(paste0(traj_from_jpl_some$re_CMU_NCEMT_mod[1]))
...
if(is.saved)
{
  filename = paste0(FILE_PREFIX_FROM_JPL, "_ppt_x0_y0_NCEM_from_jpl")
...
ppt_x0_z0_NCEM_from_jpl = ggplot() + geom_path(data = traj_from_jpl_some_leg1, aes.pk, size = line.size.EM)

# Orbit in black
#ppt_x0_z0_NCEM_from_jpl = ppt_x0_z0_NCEM_from_jpl + geom_path(data = traj_from_jpl_some_emlt, aes.pk, size = line.size.EM, color = "black")
...
ppt_x0_z0_NCEM_from_jpl = ppt_x0_z0_NCEM_from_jpl + scale.color.jpl.local.noguide
ppt_x0_z0_NCEM_from_jpl = ppt_x0_z0_NCEM_from_jpl + scale.line.jpl.local.noguide

# Add EMLi
ppt_x0_z0_NCEM_from_jpl = ppt_x0_z0_NCEM_from_jpl + geom_point(data = dfemli, aes(x= x_NC, y = z_NC), size = 4) 
ppt_x0_z0_NCEM_from_jpl = ppt_x0_z0_NCEM_from_jpl + annotate("text", x = 0, y = -0.17,  label = "EML[2]", size = 5, parse = TRUE)

# Labels
ppt_x0_z0_NCEM_from_jpl = ppt_x0_z0_NCEM_from_jpl + labs(x = x_em, y = z_em)

# Add the Moon
#ppt_x0_z0_NCEM_from_jpl = addMoon(ppt_x0_z0_NCEM_from_jpl, x = dfmoon_eml$x_NC, y = 0, dfmoon_eml$r_NC, surfSize = 0.4, cratSize = 0.2)

# Zoom
ppt_x0_z0_NCEM_from_jpl = ppt_x0_z0_NCEM_from_jpl + scale_x_continuous(limits = lim.x.NEM)
ppt_x0_z0_NCEM_from_jpl = ppt_x0_z0_NCEM_from_jpl + scale_y_continuous(limits = lim.z.NEM)
#ppt_x0_z0_NCEM_from_jpl = ppt_x0_z0_NCEM_from_jpl + ggtitle(paste0(traj_from_jpl_some$re_CMU_NCEMT_mod[1]))
...
if(is.saved)
{
  filename = paste0(FILE_PREFIX_FROM_JPL, "_ppt_x0_z0_NCEM_from_jpl")
...
ppt_y0_z0_NCEM_from_jpl = ggplot() + geom_path(data = traj_from_jpl_some_leg1, aes.pk, size = line.size.EM)

# Orbit in black
#ppt_y0_z0_NCEM_from_jpl = ppt_y0_z0_NCEM_from_jpl + geom_path(data = traj_from_jpl_some_emlt, aes.pk, size = line.size.EM, color = "black")

# Theme and titles
ppt_y0_z0_NCEM_from_jpl = ppt_y0_z0_NCEM_from_jpl + theme_pgrey(color.back)
#ppt_y0_z0_NCEM_from_jpl = ppt_y0_z0_NCEM_from_jpl + coord_fixed(ratio=1)
ppt_y0_z0_NCEM_from_jpl = ppt_y0_z0_NCEM_from_jpl + scale.color.jpl.local.noguide
ppt_y0_z0_NCEM_from_jpl = ppt_y0_z0_NCEM_from_jpl + scale.line.jpl.local.noguide

# Add EMLi
ppt_y0_z0_NCEM_from_jpl = ppt_y0_z0_NCEM_from_jpl + geom_point(data = dfemli, aes(x= y_NC, y = z_NC), size = 4) 
ppt_y0_z0_NCEM_from_jpl = ppt_y0_z0_NCEM_from_jpl + annotate("text", x = 0, y = -0.14,  label = "EML[2]", size = 5, parse = TRUE)

# Labels
ppt_y0_z0_NCEM_from_jpl = ppt_y0_z0_NCEM_from_jpl + labs(x = y_em, y = z_em)

# Add the Moon
#ppt_y0_z0_NCEM_from_jpl = addMoon(ppt_y0_z0_NCEM_from_jpl, x = dfmoon_eml$x_NC, y = 0, dfmoon_eml$r_NC, surfSize = 0.4, cratSize = 0.2)

# Zoom
ppt_y0_z0_NCEM_from_jpl = ppt_y0_z0_NCEM_from_jpl + scale_x_continuous(limits = lim.y.NEM)
ppt_y0_z0_NCEM_from_jpl = ppt_y0_z0_NCEM_from_jpl + scale_y_continuous(limits = lim.z.NEM)
#ppt_y0_z0_NCEM_from_jpl = ppt_y0_z0_NCEM_from_jpl + ggtitle(paste0(traj_from_jpl_some$re_CMU_EMT_mod[1]))

# Right font
ppt_y0_z0_NCEM_from_jpl = set_font_cm(ppt_y0_z0_NCEM_from_jpl)

ppt_y0_z0_NCEM_from_jpl

# Save
if(is.saved)
{
  filename = paste0(FILE_PREFIX_FROM_JPL, "_ppt_y0_z0_NCEM_from_jpl")
  ggsave(ppt_y0_z0_NCEM_from_jpl, width = xSize, height = ySize,  bg = "transparent",  device = cairo_pdf, file = paste0(filename, ".pdf"))            #Save in pdf
  ggsave(ppt_y0_z0_NCEM_from_jpl, width = xSize, height = ySize,  bg = "transparent",  dpi = dpi, file = paste0(filename, ".png")) #Save in png
}