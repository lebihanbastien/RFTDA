################################################################################
#
# Projection from single orbits. Requires MAIN.R
#
# BLB 2017
#
################################################################################
...
condition =  proj_map_source$s1_CMU_EM_seed == 40   

#Factorize t0_CMU_EM_seed_T 
#proj_map_source$t0_CMU_EM_seed_T = factor(proj_map_source$t0_CMU_EM_seed_T)

# Select (or not) the value that match with the condition
...
# compute_first_point <- function(df)
# {
#   summarize(df,
...
# }
# 
# proj_map_first  = ddply(proj_map_orbit, .(label), compute_first_point)
